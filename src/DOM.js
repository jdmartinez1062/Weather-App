...
const updateTemp = (weather, tempUnit) => {
  ...
  if (tempUnit === '°C') {
    ...
    tempMax.textContent = `Maximum Temperature: ${celcius(
      weather.temp_max,
    )} °C`;
    tempMin.textContent = `Minimum Temperature: ${celcius(
      weather.temp_min,
    )} °C`;
  } else {
    temp.textContent = `Current Temperature: ${farenheit(weather.temp)} °F`;
    tempMax.textContent = `Maximum Temperature: ${farenheit(
      weather.temp_max,
    )} °F`;
    tempMin.textContent = `Minimum Temperature: ${farenheit(
      weather.temp_min,
    )} °F`;
  }
};
