...
/* harmony default export */ const src_Weather = (Weather);
;// CONCATENATED MODULE: ./src/calculations.js
...
var updateTemp = function updateTemp(weather, tempUnit) {
  ...
  if (tempUnit === '°C') {
    temp.textContent = "Current Temperature: ".concat(celcius(weather.temp), " \xB0C");
    tempMax.textContent = "Maximum Temperature: ".concat(celcius(weather.temp_max), " \xB0C");
    tempMin.textContent = "Minimum Temperature: ".concat(celcius(weather.temp_min), " \xB0C");
  } else {
    temp.textContent = "Current Temperature: ".concat(farenheit(weather.temp), " \xB0F");
    tempMax.textContent = "Maximum Temperature: ".concat(farenheit(weather.temp_max), " \xB0F");
    tempMin.textContent = "Minimum Temperature: ".concat(farenheit(weather.temp_min), " \xB0F");
  }
};
...
/* harmony default export */ const DOM = (showWeather);
...
var getWeather = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(city) {
    var API_KEY;
          ...
          case 0:
            ...
            fetch("https://api.openweathermap.org/data/2.5/weather?q=".concat(city, "&appid=").concat(API_KEY), {
              ...
              response.json().then(function (response) {
                DOM(_construct(src_Weather, _toConsumableArray(objectBuilder(response))));
              });
            });
